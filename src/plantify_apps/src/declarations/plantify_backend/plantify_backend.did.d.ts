...
export type MyInvestmentPortfolioResponse =
  | { Error: string }
...
export type Result_12 = { ok: PaginatedNFTs } | { err: string };
...
export type UserType = { Founder: null } | { Investor: null };
...
export type VoteType = { Approve: null } | { Reject: null } | { Abstain: null };
