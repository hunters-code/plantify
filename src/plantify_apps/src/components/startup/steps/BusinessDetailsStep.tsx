...
const BusinessDetailsStep: React.FC<BusinessDetailsStepProps> = ({ formData, setFormData, errors = {} }) => {
  ...
  return (
    <div className="space-y-6">
      <div className="mb-8">
        <h2 className="text-2xl font-semibold font-ibm text-gray-900 mb-2">Business Model & Strategy</h2>
      </div>
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          {errors.marketingStrategy && (
            <p className="mt-1 text-sm text-red-600">{errors.marketingStrategy}</p>
          )}
        </div>
        ...
        <div>
          ...
          {errors.operationalProcess && (
            <p className="mt-1 text-sm text-red-600">{errors.operationalProcess}</p>
          )}
        </div>
      </div>
    </div>
