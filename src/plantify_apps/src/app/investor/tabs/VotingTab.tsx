...
export default function VotingTab({ onBackToOverview }: VotingTabProps) {
  const [votes, setVotes] = useState<Record<string, 'approve' | 'reject' | 'abstain'>>({});
  ...
  const handleVote = async (reportId: string, voteType: 'approve' | 'reject' | 'abstain') => {
    try {
      setIsLoading(true);
                ...
                <div className="bg-gray-50 rounded-lg p-6">
                  ...
                  <div className="grid grid-cols-3 gap-12 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-2xl font-bold text-gray-900">{report.investorCount}</p>
                    </div>
                  </div>
