    ...
    <Card className="bg-neutral-100">
      <div className="grid grid-cols-3 gap-6 mb-8">
        <Card className="text-center p-6">
          ...
          <div className="text-xs text-gray-400 mt-1">Total collateral needed (ckUSDC)</div>
        </Card>
        <Card className="text-center p-6">
          <div className="text-3xl font-bold text-gray-900 mb-2">$4,800</div>
          <div className="text-sm text-gray-500">Deposited Amount</div>
          <div className="text-xs text-gray-400 mt-1">Current deposits (ckUSDC)</div>
        </Card>
        <Card className="text-center p-6">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-medium text-gray-700">Collateral Progress: 100% Funded</span>
        ...
        <div className="space-y-4">
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <div className="text-sm font-semibold text-green-600">+$2,000 ckUSDC</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg p-4 border border-gray-200">
            <div className="flex justify-between items-center">
              ...
              <div className="text-right">
                <div className="text-sm font-semibold text-green-600">+$2,800 ckUSDC</div>
              </div>
            </div>
          </div>
        </div>
