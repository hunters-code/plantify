...
import { Camera, CheckCircle2, ShieldUser } from 'lucide-react';

/**
 * HowItWork.jsx
 * UI section with two tabs (For Founders / For Investors) and a stacked-card
 * illustration that flips forward when a tab is selected.
 *
 * Requirements:
 * - TailwindCSS
...
export default function HowItWork() {
  ...
  // Card stack visuals for each tab
