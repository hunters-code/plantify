...
const ReviewSubmitStep = ({ formData, onEdit }) => {
        ...
        <div className="space-y-6">
          ...
          <div className="pt-6 border-t border-gray-200">
            <div className="grid grid-cols-2 gap-x-12 gap-y-3 text-sm">
              ...
              <div>
                <span className="text-gray-600 text-sm">Role</span>
                <p className="text-gray-900 font-semibold">CTO</p>
              </div>
              <div>
                <span className="text-gray-600 text-sm">Email</span>
                <p className="text-gray-900 font-semibold">michael@ecotechsolutions.com</p>
              </div>
              <div>
                <span className="text-gray-600 text-sm">LinkedIn</span>
                <p className="text-gray-900 font-semibold">https://linkedin.com/in/michaelchen</p>
              </div>
            </div>
            <div className="mt-4">
              <span className="text-gray-600 text-sm">Professional background</span>
              <p className="text-gray-900 font-semibold text-sm mt-1">Ex-Google AI researcher specializing in machine learning for energy optimization</p>
            </div>
          </div>
