      ...
      <div className="space-y-4">
          ...
          <div className="flex items-start gap-3">
            <div
              className={`w-5 h-5 flex items-center justify-center rounded-md border ${
                agreements.terms ? "bg-blue-600 border-blue-600" : "border-gray-300"
              }`}
            >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                I have read and understand the platform terms, founder obligations, and
        ...
        >
          <div className="flex items-start gap-3">
            <div
              className={`w-5 h-5 flex items-center justify-center rounded-md border ${
                agreements.risks ? "bg-blue-600 border-blue-600" : "border-gray-300"
              }`}
            >
            ...
            <div>
              ...
              <p className="text-sm text-gray-600">
                I understand that fundraising involves 36-month commitments, collateral
                requirements, and monthly reporting obligations.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex items-start gap-3">
            <div
              className={`w-5 h-5 flex items-center justify-center rounded-md border ${
                agreements.transparency ? "bg-blue-600 border-blue-600" : "border-gray-300"
              }`}
            >
              {agreements.transparency && <Check className="w-4 h-4 text-white" />}
            </div>
            <div>
              <div className="font-medium text-gray-900 text-[16px]">
              ...
              <p className="text-sm text-gray-600">
                I will maintain open communication with investors and uphold the values
                of the Plantify community.
              </p>
            </div>
          </div>
        </div>
