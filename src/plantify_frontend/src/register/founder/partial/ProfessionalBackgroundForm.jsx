...
export default function ProfessionalBackgroundForm({ formData, handleInputChange, nextStep, prevStep }) {
    ...
    return (
        <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-8 font-ibm">Professional Background</h2>
