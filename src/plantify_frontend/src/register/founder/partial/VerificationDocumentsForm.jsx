...
function FileUpload({ label, required = false, acceptedFormats = "jpg, png, or pdf max 2MB", onChange }) {
    ...
    return (
        <div>
            ...
            <div
                className={`relative flex flex-col items-center justify-center gap-2 p-8 rounded-xl border-2 border-dashed transition-all duration-200 cursor-pointer ${dragActive
                ...
                {selectedFile ? (
                    ...
                    <div className="flex items-center gap-3 text-center">
                        ...
                        <div className="flex flex-col gap-1 text-left">
                            <div className="text-gray-900 font-medium">Choose or drag the file here</div>
...
function VerificationDocumentsForm({ formData, handleInputChange }) {
    ...
    return (
        <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-8 font-ibm">Verification Documents</h2>
