...
export type Result_2 = { Ok: TxIndex } | { Err: TransferFromError };
export type Result_3 = { Ok: TxIndex } | { Err: ApproveError };
export type Result_4 = { Ok: TxIndex } | { Err: TransferError };
...
export interface ckUSDC {
  create_token: ActorMethod<
    ...
    Result_1
  >;
  delete_token: ActorMethod<[], Result_1>;
  ...
  icrc2_transfer_from: ActorMethod<
    ...
    Result_2
  >;
  initialize_with_supply: ActorMethod<[bigint], Result_1>;
  mint: ActorMethod<[Account, bigint], Result>;
  mint_to_self: ActorMethod<[bigint], Result>;
