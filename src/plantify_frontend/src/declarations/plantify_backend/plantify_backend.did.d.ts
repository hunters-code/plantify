...
export type CollateralProgressResponse =
  | { Error: string }
...
export type NFTOwnerResponse =
  | { Error: string }
  | { Success: { tokenId: bigint; owner: [] | [NFTAccount] } };
export type Result = { ok: TransferNFTResponse } | { err: string };
export type Result_1 = { ok: TopUpResponse } | { err: string };
export type Result_10 = { ok: Array<CollateralTopUp> } | { err: string };
export type Result_11 = { ok: CollateralInfo } | { err: string };
export type Result_12 = { ok: Startup } | { err: string };
export type Result_13 = { ok: boolean } | { err: string };
export type Result_2 = { ok: Investor } | { err: string };
export type Result_3 = { ok: Founder } | { err: string };
export type Result_4 = { ok: string } | { err: string };
export type Result_5 = { ok: MintNFTResponse } | { err: string };
export type Result_6 = { ok: Array<NFTInfo> } | { err: string };
export type Result_7 = { ok: NFTOwnerResponse } | { err: string };
export type Result_8 = { ok: NFTInfo } | { err: string };
export type Result_9 = { ok: NFTBalanceResponse } | { err: string };
