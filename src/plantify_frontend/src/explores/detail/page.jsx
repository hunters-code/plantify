            ...
            <div className="max-w-6xl mx-auto px-6 py-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="bg-neutral-100 rounded-2xl p-6 flex flex-col gap-4">
                    ...
                    <div className="space-y-2 text-sm">
                        <p className="flex gap-2 items-center"><ChartCandlestick size={20} className="text-neutral-500" /> Periodic Returns: <span className="font-semibold">$12</span></p>
                        <p className="flex gap-2 items-center"><BanknoteArrowUp size={20} className="text-neutral-500" /> Annual ROI: <span className="font-semibold">19.2%</span></p>
                        <p className="flex gap-2 items-center"><GalleryHorizontalEnd size={20} className="text-neutral-500" /> Available: <span className="font-semibold">167 NFT</span></p>
                        <p className="flex gap-2 items-center">
                            <Sparkle size={20} className="text-neutral-500" /> Funding Progress:{" "}
